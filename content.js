...
function showLoadingOverlay() {
  if (document.getElementById("n8n-analysis-overlay")) {
    ...
    document.getElementById("n8n-content").innerHTML = "⏳ Running analysis. This might take a minute for massive threads...";
    return;
  }
  ...
  overlay.innerHTML = `
    ...
    <div id="n8n-content" class="n8n-markdown-container">⏳ Running analysis. This might take a minute for massive threads...</div>
  `;
